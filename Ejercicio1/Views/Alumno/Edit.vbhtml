        ...
        <div class="editor-field">
            ...
            If Model IsNot Nothing Then
                ...
                @<li>
                    ...
                    <label>Detalle</label>
                    @Html.DropDownListFor(Function(model) model.Telefonos(i).Detalle, New SelectList(New List(Of SelectListItem)() From { _
                                    ...
                                    }, "Value", "Text", Model.Telefonos(i).Detalle))
...
<script>
    ...
    btnAgregar.addEventListener("click", function () {
        var indexTelefono = cantidadHijosLi("telefonos") - 1;
        if (indexTelefono < 0) {
            indexTelefono = 0;
        }
        ...
        "<li>" +
            "<label>Número</label>" +
            "<input type='text' name='Telefonos[" + indexTelefono + "].Numero' />" +
            "<label>Zona</label>" +
            "<input type='text' name='Telefonos[" + indexTelefono + "].Zona' />" +
            "<label>Detalle</label>" +
